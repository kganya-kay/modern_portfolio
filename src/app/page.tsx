...
const user = {
  ...
  imageUrl:"https://qgl4gv7np8.ufs.sh/f/zFJP5UraSTwKDWsL9ERzGfn8OhYAcm3stI41pXWPSaxRd7rE",
};
const navigation = [
  ...
  return (
    <HydrateClient>
      <div className="min-h-full">
        ...
        <main>
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 bg-gray-700">
            {
              <Dashboard/>
            }
          </div>
